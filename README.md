...
|---------|--------|-------|------------|
| Jira Software | 8.2.3 | 8.2.3, latest, latest.de | [Dockerfile](https://github.com/teamatldocker/jira/blob/master/Dockerfile) |
...
| Jira Core | 8.2.3 | core, core.8.2.3, core.de, core.8.2.3.de | [Dockerfile](https://github.com/teamatldocker/jira/blob/master/Dockerfile) |
